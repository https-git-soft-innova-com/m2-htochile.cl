...
export type Product = {
  ...
  name: string
  category: string
  group: "fittings" | "mangueras" | "prensas"
  brand: string
  industry: string
  image: string
  short: string
...
export const products: Product[] = [
  ...
  {
    slug: "ferrula-sae-r1-at",
    name: "Férula SAE R1AT",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Minería",
    image: "/images/products/ferrula-sae-r1-at.png",
    short: "Férula SAE para armado de mangueras hidráulicas de alta presión.",
    specs: [
      { label: "Norma", value: "SAE 100 R1AT" },
      { label: "Aplicación", value: "Mangueras hidráulicas" },
      { label: "Material", value: "Acero carbono" },
    ],
  },
  {
    slug: "ferrula-sae-r2-at",
    name: "Férula SAE R2AT",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Minería",
    image: "/images/products/ferrula-sae-r2-at.png",
    short: "Férula SAE para armado de mangueras hidráulicas de doble trenzado.",
    specs: [
      { label: "Norma", value: "SAE 100 R2AT" },
      { label: "Aplicación", value: "Mangueras hidráulicas" },
      { label: "Material", value: "Acero carbono" },
    ],
  },
  {
    slug: "ferrula-din-r1-r2-at",
    name: "Férula DIN R1/R2AT",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Construcción",
    image: "/images/products/ferrula-din-r1-r2-at.png",
    short: "Férula DIN para ensamblaje de mangueras hidráulicas R1 y R2.",
    specs: [
      { label: "Norma", value: "DIN / EN 853" },
      { label: "Aplicación", value: "Mangueras R1 y R2" },
      { label: "Material", value: "Acero carbono" },
    ],
  },
  {
    slug: "ferrula-r7-r6-r14",
    name: "Férula R7, R6 y R14",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Construcción",
    image: "/images/products/ferrula-r7-r6-r14.png",
    short: "Férula para mangueras termoplásticas y aplicaciones hidráulicas compactas.",
    specs: [
      { label: "Aplicación", value: "Mangueras R7, R6 y R14" },
      { label: "Material", value: "Acero carbono" },
      { label: "Uso", value: "Armado hidráulico" },
    ],
  },
  {
    slug: "ferrula-r12-4sh-no-pelar",
    name: "Férula R12 4SH No Pelar",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Minería",
    image: "/images/products/ferrula-r12-4sh-no-pelar.png",
    short: "Férula no pelar para mangueras hidráulicas SAE 100 R12 y 4SH.",
    specs: [
      { label: "Aplicación", value: "R12 / 4SH" },
      { label: "Tipo", value: "No pelar" },
      { label: "Material", value: "Acero carbono" },
    ],
  },
  {
    slug: "ferrula-r12-4sh-pelar",
    name: "Férula R12 4SH Pelar",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Minería",
    image: "/images/products/ferrula-r12-4sh-pelar.png",
    short: "Férula pelar para mangueras hidráulicas SAE 100 R12 y 4SH.",
    specs: [
      { label: "Aplicación", value: "R12 / 4SH" },
      { label: "Tipo", value: "Pelar" },
      { label: "Material", value: "Acero carbono" },
    ],
  },
  {
    slug: "ferrula-r12-4sp-no-pelar",
    name: "Férula R12 4SP No Pelar",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Minería",
    image: "/images/products/ferrula-r12-4sp-no-pelar.png",
    short: "Férula no pelar para mangueras hidráulicas SAE 100 R12 y 4SP.",
    specs: [
      { label: "Aplicación", value: "R12 / 4SP" },
      { label: "Tipo", value: "No pelar" },
      { label: "Material", value: "Acero carbono" },
    ],
  },
  {
    slug: "ferrula-r12-4sp-pelar",
    name: "Férula R12 4SP Pelar",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Minería",
    image: "/images/products/ferrula-r12-4sp-pelar.png",
    short: "Férula pelar para mangueras hidráulicas SAE 100 R12 y 4SP.",
    specs: [
      { label: "Aplicación", value: "R12 / 4SP" },
      { label: "Tipo", value: "Pelar" },
      { label: "Material", value: "Acero carbono" },
  ...
  {
    slug: "terminal-fjx-hembra",
    name: "Terminal FJX Hembra",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Construcción",
    image: "/images/products/female-fjx-hembra.png",
    short: "Terminal hembra FJX para conexiones hidráulicas de alta presión.",
    specs: [
      { label: "Tipo", value: "FJX hembra" },
      { label: "Material", value: "Acero carbono" },
      { label: "Aplicación", value: "Líneas hidráulicas" },
    ],
  },
  {
    slug: "terminal-fjx-90-hembra",
    name: "Terminal FJX Hembra 90°",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Construcción",
    image: "/images/products/female-fjx-90-hembra.png",
    short: "Terminal hembra FJX a 90° para facilitar el tendido de líneas hidráulicas.",
    specs: [
      { label: "Tipo", value: "FJX hembra 90°" },
      { label: "Material", value: "Acero carbono" },
      { label: "Aplicación", value: "Líneas hidráulicas" },
    ],
  },
  {
    slug: "terminal-fjx-one-piece",
    name: "Terminal FJX One Piece",
    category: "Conexiones y Acoples",
    group: "fittings",
    brand: "Parker",
    industry: "Minería",
    image: "/images/products/female-fjx-one-piece.png",
    short: "Terminal FJX de una pieza para ensamblajes hidráulicos confiables.",
    specs: [
      { label: "Tipo", value: "FJX one piece" },
      { label: "Material", value: "Acero carbono" },
      { label: "Aplicación", value: "Mangueras hidráulicas" },
    ],
  },
